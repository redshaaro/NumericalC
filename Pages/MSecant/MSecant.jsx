...
import modifiedSecantMethod from "../../utils/modifiedSecantMethod";
import "./MSecant.css";
...
const MSecant = () => {
  ...
  const submitHandler = (e) => {
    ...
    if (!equation || !a || !b || !tolerance) {
      ...
      setOutput(modifiedSecantMethod(equation, a, b, tolerance));
      setError(false);
    }
  };
  ...
  return (
    <>
      <h1 className="SecantTitle">MSecantMethod</h1>
